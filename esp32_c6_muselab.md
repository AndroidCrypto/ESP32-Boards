---
layout: page
title: ESP32-C6 Muselab nanoESP32
permalink: esp32_c6_muselab_nanoesp32_c6
---

> This is an ESP32-C6 Dev. Board from <b>Muselab</b> that is sold under <b>nanoESP32-C6</b>.

<font color="red">Please note that the following data is for a different processor and board !</font>
...
- [Hartmut Waller](https://hartmut-waller.info/arduinoblog/esp32-mit-28-zoll-tft/) A lot of examples for the display, RGB LED and SD-Card reader [German]
...
|----------------------------------------|--|
| Processor: | ESP32-C6 module with dual-core Xtensa LX7 (ESP32-D0WD-V3 (revision v3.1)), Flash 4 MB, no PSRAM |
